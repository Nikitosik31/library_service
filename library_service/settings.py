...
SECRET_KEY = (
    "django-insecure-heqv7^_xz)a*7t&0sqpz$6)fv%0+2q!m07^s4j1-(q5!r3kyll"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Manage books, borrowings and payments",
    "VERSION": "1.0.0",
    "SERVE_INCLUDE_SCHEMA": False,  # не показывать сырую схему в UI
    "SWAGGER_UI_SETTINGS": {
        "deepLinking": True,
